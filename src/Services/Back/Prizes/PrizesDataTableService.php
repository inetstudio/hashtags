...
namespace InetStudio\Hashtags\Services\Back\Prizes;
...
class PrizesDataTableService extends DataTable implements PrizesDataTableServiceContract
{
    ...
    {
        $transformer = app()->make('InetStudio\Hashtags\Contracts\Transformers\Back\Prizes\PrizeTransformerContract');
    ...
    {
        return [
            'url' => route('back.hashtags.prizes.data.index'),
            'type' => 'POST',
        ];
    }

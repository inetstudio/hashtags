...
namespace InetStudio\Hashtags\Services\Back\Tags;
...
class TagsDataTableService extends DataTable implements TagsDataTableServiceContract
{
    ...
    {
        $transformer = app()->make('InetStudio\Hashtags\Contracts\Transformers\Back\Tags\TagTransformerContract');
    ...
    {
        return [
            'url' => route('back.hashtags.tags.data.index'),
            'type' => 'POST',
        ];
    }
